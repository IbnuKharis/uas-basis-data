...
<html>
<head>
<title>Dustech Store - Daftar Belanja</title>
<!-- for-mobile-apps -->
...
<div class="footer">
			...
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						...
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">ibnukharis@gmail.com</a></li>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 202 Ibnu Kharis. All rights reserved</p>
			</div>
		</div>
